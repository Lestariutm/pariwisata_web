        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i><a href="<?php echo base_url().'index.php/Admin_gambar'; ?>">Dashboard</a></li>
            </ol>
          </div>
        </div>
  <div class="container">
    <form action="<?php echo base_url('index.php/Admin_gambar/save'); ?>" method="POST" enctype="multipart/form-data">
